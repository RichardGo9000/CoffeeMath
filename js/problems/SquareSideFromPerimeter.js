...
export class SquareSideFromPerimeterProblem extends Problem {
    constructor() {
        super();
    }
    mathFn(digitCountA) {
        ...
        this.question = `What is the side length of a square with a perimeter ${a}`;
        this.display();
        return {question: this.question, answer: this.answer };
    }
}

export default SquareSideFromPerimeterProblem;
